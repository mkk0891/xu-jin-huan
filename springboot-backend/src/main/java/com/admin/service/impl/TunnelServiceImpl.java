...
public class TunnelServiceImpl extends ServiceImpl<TunnelMapper, Tunnel> implements TunnelService {
    ...
    public R updateTunnel(TunnelUpdateDto tunnelUpdateDto) {
        ...
        existingTunnel.setBillingMode(StringUtils.isBlank(tunnelUpdateDto.getBillingMode()) ? "LEGACY" : tunnelUpdateDto.getBillingMode());
    ...
    private Tunnel buildTunnelEntity(TunnelDto tunnelDto, Node inNode) {
        ...
        tunnel.setBillingMode(StringUtils.isBlank(tunnelDto.getBillingMode()) ? "LEGACY" : tunnelDto.getBillingMode());
